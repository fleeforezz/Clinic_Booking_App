...
public partial class Clinic_Booking_App_DatabaseContext : DbContext
{
    public Clinic_Booking_App_DatabaseContext()
    {
    }

    public Clinic_Booking_App_DatabaseContext(DbContextOptions<Clinic_Booking_App_DatabaseContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=10.0.1.46;Initial Catalog=Clinic_Booking_App_Database;Persist Security Info=True;User ID=jso;Password=TMNNT_012928637160822863716");
